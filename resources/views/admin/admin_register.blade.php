...
<head>
  ...
  <title>Admin Sign Up - Home Service Marketplace</title>
...
<body class="bg-emerald-200">
  ...
  <div class="min-h-screen flex items-center justify-center">
    <div class="flex w-full max-w-6xl bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div class="w-1/2 p-8">
        <h2 class="text-2xl font-bold text-center text-green-600 mb-6">Create Your Admin Account</h2>
        ...
        @csrf
          ...
          <div class="mb-4">
            ...
            <input type="text" id="location_name" name="location_name" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" placeholder="Your Location" required>
          </div>
          ...
          <div class="mb-4">
            ...
            <select id="role" name="role" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
          ...
          <!-- Education -->
          <div class="mb-4">
            <label for="education" class="block text-gray-700">Education (Optional)</label>
            <input type="text" id="education" name="education" class="w-full px-4 py-2 mt-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" placeholder="Your Educational Background">
          </div>
